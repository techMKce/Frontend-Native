...
export default function ResubmitAssignmentScreen() {
  ...
  useEffect(() => {
    // Only fetch data if the student is enrolled
  ...
  }, [assignmentId, studentRollNumber, checkingEnrollment, isEnrolled]);
  ...
  const handleDownloadFacultyFile = async () => {
    ...
    try {
      ...
      // Extract file extension from original file name or use pdf as default
      const fileExtension = 'pdf'; // Use appropriate logic to get actual extension if available
              ...
              <View style={styles.fileRow}>
                ...
                <View style={styles.fileActions}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => {
                      const fileExtension = 'pdf'; // Default to PDF
