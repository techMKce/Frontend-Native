    ...
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'space-between' }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {setShowSection(false); setShowAss(true); setShowReport(false);}}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => {setShowSection(false); setShowAss(false); setShowReport(true);}}
        >
          <Text style={[styles.submitButtonText, { color: showReport ? '#fff' : '#000' }]}>Reports</Text>
        </TouchableOpacity>  
