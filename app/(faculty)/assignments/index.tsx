            ...
            <View key={assignment.id} style={styles.assignmentCard}>
              <View style={styles.assignmentHeader}>
                ...
                <View style={styles.actionButtons}>
                  <TouchableOpacity style={styles.iconButton} onPress={() => handleEditAssignment(assignment.id)}>
                    <Edit2 size={18} color={COLORS.primary} />
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.iconButton} onPress={() => handleDeleteAssignment(assignment.id)}>
              ...
              <View style={styles.assignmentDetails}>
                ...
                <TouchableOpacity style={styles.gradeButton} onPress={() => handleGradeSubmissions(assignment.id)}>
