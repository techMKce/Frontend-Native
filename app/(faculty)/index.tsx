...
//     return () => console.log('DateTimePicker unmounted');
//   }, [showDatePicker]);
...
//     const { type } = event;
//     console.log('DateTimePicker Event:', event); // Debugging

//     if (type === 'set' && selectedDate) {
//       setForm({ ...form, dueDate: selectedDate });
//       if (Platform.OS === 'android') {
//         // Delay hiding to avoid native dismissal conflict
//         setTimeout(() => setShowDatePicker(false), 100);
//       }
//     } else if (type === 'dismissed' && Platform.OS === 'android') {
